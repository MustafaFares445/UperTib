...
const REASON_BY_STATUS: Record<ProviderOption['eligibility'], { reasonSummary: string; nextStep: string }> = {
  ELIGIBLE: {
    reasonSummary: 'يمكنك حجز هذه الخدمة مع هذا الطبيب في هذا الفرع حاليًا.',
    nextStep: 'ارجع إلى تفاصيل الطبيب، ثم اضغط «حجز هذا الخيار» للانتقال إلى اختيار الموعد.',
  },
  PENDING_EVALUATION: {
    reasonSummary: 'ما زال التحقق من إتاحة هذه الخدمة مع هذا الطبيب قيد الاستكمال، لذلك لا يمكن حجزه الآن.',
    nextStep: 'ارجع إلى نتائج البحث واختر طبيبًا متاحًا الآن، أو عد إلى هذا الخيار لاحقًا للتحقق من حالته.',
  },
  SUSPENDED: {
    reasonSummary: 'هذه الخدمة غير متاحة مؤقتًا مع هذا الطبيب في هذا الفرع، لذلك لا يمكن متابعة الحجز الآن.',
    nextStep: 'ارجع إلى نتائج البحث واختر طبيبًا أو فرعًا آخر متاحًا لهذه الخدمة.',
  },
  NOT_ELIGIBLE: {
    reasonSummary: 'لا يمكن حجز هذه الخدمة مع هذا الطبيب في هذا الفرع حاليًا.',
    nextStep: 'ارجع إلى نتائج البحث واختر طبيبًا آخر متاحًا لهذه الخدمة.',
  },
};
